...
load_sub('scripts/CS_Model_Code_V40.R', encoding = 'UTF-8') #debugSource
...
load_sub('scripts/Geology_Model_Code_V1.R', encoding = 'UTF-8') #debugSource
...
server <- function(input, output, session) {
  ...
  observeEvent(input$RGM,{
    ...
    valid_C = ggplot()+
      ...
      labs(x="Measure & Estemat",y="Model")
